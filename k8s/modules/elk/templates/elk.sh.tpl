...
# copy over configs
cp /temp/configs/elasticsearch/elasticsearch.yml /etc/elasticsearch/
...
# copy over configs
cp /temp/configs/kibana/kibana.yml /etc/kibana/
...
# # copy over configs
cp -R /temp/configs/logstash/* /etc/logstash/conf.d/
